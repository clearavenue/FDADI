...
<html lang="en">
<head>
<title>myMedications Login</title>
...
<body>
	...
	<div class="container fdadi-template">
		...
		<div class="row centerDiv">
			<div class="messageBox">
				<p class="h5 text-center">
					<strong>New Users:</strong> Enter a username &amp; password and
					select Register.
				</p>
				<p class="h5 text-center">
					<strong>Current Users:</strong> Enter your username &amp; password
					and select Login.
				</p>
			</div>
		</div>
				...
				<div class="panel-body">
					<form data-toggle="validator" class="form-horizontal" method="post"
						...
						<div class="form-group" id="usernameGroup">
							...
							<div class="col-sm-10">
								<input type="text" pattern="^[a-zA-Z0-9_\.]+$"
									data-error="Valid characters include letters, numbers, underscore (_), and period (.)"
						...
						<div class="form-group" id="pwdGroup">
							...
							<div class="col-sm-10">
								<input type="password" data-minlength="4"
									data-error="Minimum of 6 characters"
									class="form-control required" id="pwd" name="pwd"
						...
						<div class="pull-right">
							<div>
								<table>
									<tr>
										<td><input
											class="form-control btn btn-primary loginButton"
											type="submit" id="registerButton" value="Register"></td>
										<td><input
											class="form-control btn btn-primary loginButton"
		...
		<div class="aboutBox centerDiv">
			<p class="text-center">myMedications allows users to resarch
				information concerning the medications they take, including adverse
				reactions, drug interactions, and recalls.</p>
		</div>
		<div class="messageBox">
			<p class="text-center">
				<span class="glyphicon glyphicon-warning-sign"></span> DISCLAIMER:
				This website is for demonstration purposes. Information in this
				website should not be taken as medical advice.
			</p>
		</div>
