...
<body>
	...
	<div class="container fdadi-template">
		...
		<div class="aboutBox centerDiv">
			<p class="text-center">myMedications allows users to resarch information concerning the medications they take, including adverse reactions, drug interactions, and recalls.</p>
		</div>
	    <div class="messageBox">			
