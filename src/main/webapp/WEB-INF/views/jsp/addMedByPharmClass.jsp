...
<c:url value="/processAddMedByPharmClass"
	var="processAddMedByPharmClass" />
		...
		<div class="row">
			...
			<div class="col-md-6">
				<button type="button" id="getButton"
					class="btn btn-primary actionButton">Get Medications for
					PharmClass</button>
				<button type="button" id="clearButton"
					class="btn btn-primary actionButton">Uncheck</button>
				<button type="button" id="cancelButton"
					class="btn btn-primary actionButton">Cancel</button>
			</div>
		</div>
	</div>
