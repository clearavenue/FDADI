...
/**
 * The Class CheckMedicationInteractionHttpTest.
 */
public class CheckMedicationInteractionHttpTest {
	...
	/**
	 * Add Medication By Name test.
	 */
	@Test
	public void addMedicationByNameTest(){
		...
		assertTrue(driver.findElement(By.xpath("//li[text() = 'Fleet']")).isDisplayed());
